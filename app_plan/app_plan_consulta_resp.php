<?php
/**
* consulta la base de datos y genera una salida con las unidades de planificaicón dentro en un mismo marco o proyecto.
*
* @package    	geoGEC
* @subpackage 	app_plan. Aplicacion para la gestión de documento
