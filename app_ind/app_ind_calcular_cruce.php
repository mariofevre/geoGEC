...
$query="
	SELECT
			...
			FROM    
            geogec.ref_capasgeo_registros as i1,
            geogec.ref_indicadores_valores as val_i1,
            
            geogec.ref_capasgeo_registros as i2,
            geogec.ref_indicadores_valores as val_i2,
            
            geogec.ref_capasgeo_registros as c3
        WHERE
